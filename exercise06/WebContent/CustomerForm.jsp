        ...
        <html:form action="/submitCustomerForm" focus="firstName" method="GET">
            ...
            <table align="center">
                ...
                <tr>
                    ...
                    <td align="left"><html:text styleClass="mytxtbox" property="emailAddress"
            ...
            <table align="center">
                <tr>
                    <td align="right"><html:image property="save" srcKey="image.save"
                            altKey="image.save.alttext" bundle="bundle.image" /></td>
                    <td align="left"><html:image property="cancel" srcKey="image.cancel"
                            altKey="image.cancel.alttext" bundle="bundle.image" /></td>
                </tr>
            </table>
        </html:form>
