        ...
        <html:form action="/submitCustomerSearchForm" focus="lastName" method="GET">
            ...
            <table width="60%">
                <tr>
                    ...
                    <td align="left"><html:image property="searchButton" srcKey="image.search"
                            altKey="image.search.alttext" bundle="bundle.image" /></td>
                </tr>
            </table>
        </html:form>
    </div>
                    ...
                    <table width="80%" border="0">
                        ...
                        <tr align="center">
                            <td><pg:index>
                                    ...
                                    <pg:pages>
                                        <a href="<%=pageUrl%>"><c:out value="${pageNumber }"></c:out></a>
                                    </pg:pages>
                                    <pg:next>
