 ...
 * in applicationscope with the name "struts.ex9.states"
 *
  ...
  public void contextInitialized(ServletContextEvent event) {
    ...
    try {
      ...
      InputStream inStream = loader
          .getResourceAsStream("struts/ex9/states.properties");
      ...
      Set stateSet = new TreeSet(new Comparator() {
        ...
        public int compare(Object objectA, Object objectB) {
          ...
          LabelValueBean nvpA = (LabelValueBean) objectA;
          LabelValueBean nvpB = (LabelValueBean) objectB;
