...
public class CustomerAction extends Action 
{
                ...
                HttpServletRequest request, HttpServletResponse response) throws Exception
    {
        ...
        else if (custForm.getSave().isSelected())
        {
			...
			System.out.println("Customer City is " + custForm.getAddress().getCity());
			System.out.println("Customer State is " + custForm.getAddress().getState());
			System.out.println("Customer Zip code is " + custForm.getAddress().getZip());
